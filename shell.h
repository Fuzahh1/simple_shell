 ...
 * allowing uniform prototype for funtion pointer struct
 * @arg: string generated from getline containing arguements
 * @arg: an array of strings strings generated from arg
...
ssize_t get_note_index(list_t *, list_t *);
